...
def parse_args() -> ArgumentParser:
    ...
    parser.add_argument(
        "--num_processes", type=int, default=int(0.5 * cpu_count()), help="Processes"
    )
...
def image_vis(args):
    ...
    if not all(
        ...
        for f in ["trajectory_gt.npy", "attitude_gt.npy", "daytime_gt.npy", "args.json"]
    ):
    ...
    trajectory_len = np.load(os.path.join(output_dir, "trajectory_gt.npy")).shape[0]
