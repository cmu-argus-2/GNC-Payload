...
# Train RCNet
python ./RCnet/src/main.py  --train_flag --save_plot_flag --data_dir "/mnt/sdb2/training2" --model_save_path "$CURR_DIR/RCnet/model/model.pth" --model_load_path "$CURR_DIR/RCnet/model/model.pth" --save_plot_path "$CURR_DIR/RCnet/results/loss_vs_epoch.png" --learning_rate 0.0001 --epochs 10
