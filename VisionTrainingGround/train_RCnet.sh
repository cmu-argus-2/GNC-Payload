...
# Train RCNet
python ./RCnet/src/main.py --save_plot_flag --data_dir "$CURR_DIR/RCnet/datasets" --model_save_path "$CURR_DIR/RCnet/model/model.pth" --model_load_path "$CURR_DIR/RCnet/model/model.pth" --save_plot_path "$CURR_DIR/RCnet/results/loss_vs_epoch.png" --learning_rate 0.0001 --epochs 10
